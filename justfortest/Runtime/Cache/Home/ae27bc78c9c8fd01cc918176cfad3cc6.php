...
<body>
	...
	<form class="temp-form" id="login-form" action="/justfortest/justfortest/index.php/Home/user/login" method="POST">
		<h1>登录</h1>
		<p>
	...
	<form class="temp-form" id="register-form" action="/justfortest/justfortest/index.php/Home/user/register" method="POST">
		<h1>注册</h1>
		<p>
			<label for="user-id">账号：</label><input id="user-id" name="user_name" type="text" required />
		</p>
