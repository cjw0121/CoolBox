...
<body>
	<div id="main">
		<div id="header">
			<ul class="nav container">
				...
				<div class="nav-list">
					...
					<div id="nav-option">
							<li><a href="/web/coolbox/coolbox/index.php/Home/Index/index">主页</a></li>
							<li><a href="/web/coolbox/coolbox/index.php/Home/User/center">个人空间</a></li>
							<li><a href="/web/coolbox/coolbox/index.php/Home/Index/about">关于</a></li>
							<li id="major-option"><a class="right" href="/web/coolbox/coolbox/index.php/Home/User/action">登录/注册</a></li>						
					</div>
				</div>
			</ul>
		</div>
		...
		<div id="footer" class="container">
			...
			<a href="/web/coolbox/coolbox/index.php/Home/Index/index">网站首页</a> <a href="#">管理入口</a>
		</div>
	</div>
